...
You can also access parameters from the query string. For instanceForUser, if you're on `/foo?bar=baz`, you can access `this.props.location.query.bar` to get the value `"baz"` from your Route component.
